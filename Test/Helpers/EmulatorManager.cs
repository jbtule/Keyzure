//from https://gist.github.com/SeanFeldman/f0d4dde66b537896ed388331e00b1d88
namespace Test
{
    ...
    public static class AzureStorageEmulatorManager
    {
        ...
        public static readonly ProcessStartInfo startStorageEmulator = new ProcessStartInfo
        {
        ...
        public static readonly ProcessStartInfo stopStorageEmulator = new ProcessStartInfo
        {
            FileName = AzureStorageEmulatorPath,
            Arguments = "stop",
        };
